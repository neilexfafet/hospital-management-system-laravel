...
<html lang="en">
	<head>
		<title>Management  | Add Billing</title>
			...
			<div id="content-wrapper" class="d-flex flex-column">
 				...
 				@include('management.includes.header')
					<div class="container-fluid">
						<h1 class="h3 mb-4 text-gray-800">Billing Department</h1>
	                					...
	                					<div class="form-group row">
	                  					...
	                  					<div class="text-right">
	                  							<button type="submit" class="btn btn-primary btn-icon-split">
	                    							...
	                    							<span class="text">Register Handler</span>
	                    						</button>
	                    				</div>
	                				</form>
									</div>
		          ...
		          <div class="table-responsive">
		            <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
		              ...
		              @foreach ($data as $row)
			              ...
			              <td>
						  	<a href="{{ route('editbilling',['id'=>$row->id]) }}" class="btn btn-warning btn-circle btn-sm">
